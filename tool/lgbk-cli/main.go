...
import (
	...
	"github.com/yuuu/lgbk-api/tool/cli"
	"net/http"
	"os"
	"time"
)
...
func main() {
	...
	app := &cobra.Command{
		Use:   "lgbk-cli",
		Short: `CLI client for the lgbk service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:8082", "API hostname")
